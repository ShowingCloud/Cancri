$(function ($)
{
    ...
    generateBirthdayPicker = function ($input, options)
    {
        ...
        var parentId = $input.attr('id').replace(/-/g, '');
        ...
        // Create the html picker skeleton
          var $fieldset = $("<fieldset class='birthdayPicker'></fieldset>"),
            $year = $("<select class='birthYear "+options.sizeClass+"' name='"+parentId+"_birth[year]'></select>"),
              ...
              $day = $("<select class='birthDay "+options.sizeClass+"' name='"+parentId+"_birth[day]'></select>");
        ...
        $fieldset.on('change', function ()
        {
            ...
            updateTheBirthDayValue(options, $input, selectedYear, selectedMonth, selectedDay);
        });
    };
